...
errorxmax = zeros(7,1); 
errorxmin = zeros(7,1);
errorxmean = zeros(7,1);
errorxargmin = zeros(7,1);
errormmax = zeros(7,1); 
errormmin = zeros(7,1);
errormmean = zeros(7,1);
errormargmin = zeros(7,1);
errorxnoshift = zeros(7,1);
errormnoshift = zeros(7,1);
...
errorxmax(counter) = mean(max(errorx(1:2*delta-1,:),[],1));
errorxmin(counter) = mean(min(errorx(1:2*delta-1,:),[],1));
errorxargmin(counter) = mean(errorx(2*delta,:));
errorxnoshift(counter) = mean(errorx(1,:));
...
plot1 = plot(signalnoiseratio, [errorxmax errorxnoshift errorxargmin errorxmin],'LineWidth',1.5,'Parent',axes1);
set(plot1(1),'DisplayName','Max Shift','Color',[0 0 0]);
set(plot1(2),'DisplayName','No Shift','Color',[0 1 0]);
set(plot1(3),'DisplayName','Argmin Shift','LineStyle',':','Color',[0 0 1]);
set(plot1(4),'DisplayName','Min Shift','LineStyle','--','Color',[1 0 0]);
...
% Create multiple lines using matrix input to plot
plot2 = plot(signalnoiseratio, [errormmax errormnoshift errormargmin errormmin],'LineWidth',1.5,'Parent',axes2);
set(plot2(1),'DisplayName','Max Shift','Color',[0 0 0]);
set(plot2(2),'DisplayName','No Shift','Color',[0 1 0]);
set(plot2(3),'DisplayName','Argmin Shift','LineStyle','-.','Color',[0 0 1]);
set(plot2(4),'DisplayName','Min Shift','LineStyle','--','Color',[1 0 0]);
