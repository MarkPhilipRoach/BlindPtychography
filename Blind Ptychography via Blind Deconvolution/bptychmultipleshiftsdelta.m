...
errormN = zeros(6,4);
counter2 = 0;
for delta = 2:2:8 %Support of mask
counter2 = counter2 + 1;
...
[delta,SNR,test,shft,mod(t,1000),I/1000,eta,10*log10(Y3(t))]
end
...
plot1 = plot(signalnoiseratio, [errorxN(:,1) errorxN(:,2) errorxN(:,3) errorxN(:,4)],'LineWidth',1.5,'Parent',axes1);
set(plot1(1),'DisplayName','\delta = 2','Color',[0 0 0]);
set(plot1(2),'DisplayName','\delta = 4','LineStyle','-.','Color',[0 1 0]);
set(plot1(3),'DisplayName','\delta = 6','LineStyle',':','Color',[0 0 1]);
set(plot1(4),'DisplayName','\delta = 8','LineStyle','--','Color',[1 0 0]);
...
% Create multiple lines using matrix input to plot
plot2 = plot(signalnoiseratio, [errormN(:,1) errormN(:,2) errormN(:,3) errormN(:,4)],'LineWidth',1.5,'Parent',axes2);
set(plot2(1),'DisplayName','\delta = 2','Color',[0 0 0]);
set(plot2(2),'DisplayName','\delta = 4','LineStyle','-.','Color',[0 1 0]);
set(plot2(3),'DisplayName','\delta = 6','LineStyle',':','Color',[0 0 1]);
set(plot2(4),'DisplayName','\delta = 8','LineStyle','--','Color',[1 0 0]);
